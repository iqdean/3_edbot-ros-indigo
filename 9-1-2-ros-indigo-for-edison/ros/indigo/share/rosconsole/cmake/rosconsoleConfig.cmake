...
if("FALSE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /home/iqdean/ros_catkin_ws/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /home/iqdean/ros_catkin_ws/devel_isolated/rosconsole)
  ...
  set(rosconsole_INSTALL_PREFIX /home/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_print;rosconsole_backend_interface;/usr/lib/libboost_regex-mt.so;/usr/lib/libboost_system-mt.so;/usr/lib/libboost_thread-mt.so;pthread")
