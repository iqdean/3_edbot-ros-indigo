...
if("FALSE" STREQUAL "TRUE")
  set(roscreate_SOURCE_PREFIX /home/iqdean/ros_catkin_ws/src/ros/roscreate)
  set(roscreate_DEVEL_PREFIX /home/iqdean/ros_catkin_ws/devel_isolated/roscreate)
  ...
  set(roscreate_INSTALL_PREFIX /home/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
